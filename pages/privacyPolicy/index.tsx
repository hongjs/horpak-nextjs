...
const PrivacyPolicy: React.FC = () => {
  return (
    <Box>
      ...
      <p>
        At C-Place App, accessible from https://cplace.vercel.app/, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        C-Place App and how we use it.
      </p>
      ...
      <p>
        C-Place App follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, C-Place App uses &apos;cookies&apos;. These
      ...
      <p>
        ...
        advertising partners of C-Place App.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on C-Place App, which are sent
      ...
      <p>
        Note that C-Place App has no access to or control over these cookies
      ...
      <p>
        C-Place App&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        C-Place App does not knowingly collect any Personal Identifiable
