    ...
    <Container maxWidth="lg" sx={{ py: 6 }}>
      <Stack spacing={6} alignItems="center">
        ...
        <Box sx={{ textAlign: 'center', maxWidth: 600 }}>
          <CloudSyncIcon sx={{ fontSize: 64, color: 'primary.main', mb: 2, opacity: 0.8 }} />
          <Typography
            variant="h3"
            fontWeight={800}
            gutterBottom
          ...
          <Typography variant="body1" color="text.secondary">
            Manage the connection to Google Drive and Spreadsheets for data storage.
          </Typography>
        </Box>
                ...
                >
                  <Grid container spacing={2}>
                    ...
                    <Grid size={6}>
                      ...
                      <Typography variant="body2" fontWeight="500">
                        {dateFormat(toInteger(Date.parse(user.updatedDate)), 'yyyy-MM-dd HH:mm')}
                      </Typography>
                    </Grid>
                    <Grid size={6}>
                      <Typography variant="caption" color="text.secondary" display="block">
                      ...
                      <Typography
                        ...
                        fontWeight="500"
                        color={
                          new Date(toInteger(Date.parse(user.expiryDate))) < new Date()
                            ? 'error.main'
                            : 'text.primary'
                        }
                      >
                        {dateFormat(toInteger(Date.parse(user.expiryDate)), 'yyyy-MM-dd HH:mm')}
                      </Typography>
                    </Grid>
                  </Grid>
                </Box>
