    ...
    >
      <Box sx={{ width: "800px" }}>
        ...
        <p>
          ...
          by C-Place App and how we use it.
        </p>
        ...
        <p>
          C-Place App follows a standard procedure of using log files. These
        ...
        <p>
          C-Place App&apos;s Privacy Policy does not apply to other advertisers
