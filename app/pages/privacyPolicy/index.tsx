  ...
  return (
    ...
    >
      <Box sx={{ width: '800px' }}>
        ...
        <p>
          At C-Place App, accessible from https://cplace.vercel.app/, one of our main priorities is
          the privacy of our visitors. This Privacy Policy document contains types of information
          that is collected and recorded by C-Place App and how we use it.
        </p>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in C-Place App.
          ...
          <a>Privacy Policy Generator</a> and the <a>Free Privacy Policy Generator</a>.
        </p>
        ...
        <p>
          C-Place App follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          Like any other website, C-Place App uses &apos;cookies&apos;. These cookies are used to
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links that appear on C-Place
          App, which are sent directly to users&apos; browser. They automatically receive your IP
        ...
        <p>
          Note that C-Place App has no access to or control over these cookies that are used by
        ...
        <p>
          C-Place App&apos;s Privacy Policy does not apply to other advertisers or websites. Thus,
        ...
        <p>
          C-Place App does not knowingly collect any Personal Identifiable Information from children
